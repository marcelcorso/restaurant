...
void createSLEngine(void)
{

    LOGI("createSLEngine(void)");
...
void createBufferQueueAudioPlayer(void)
{
    LOGI("createBufferQueueAudioPlayer(void)");
    SLresult result;
...
void selectClip(void) {
    LOGI("selectClip(void)");
